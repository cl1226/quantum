...
import org.excitinglab.quantum.spark.apis._
import org.excitinglab.quantum.spark.config.ConfigRuntimeException
...
object ConfigBuilder {
  ...
  val PackagePrefix = "org.excitinglab.quantum.spark.core"
